          ...
          {showForm && (
            ...
            >
              <InputGroup
                ...
                name="school"
                value={
                  mode === 'edit' ? list[formIndex].school : newEducation.school
                }
                onChange={
                  mode === 'edit'
                    ? handleInputChange
                    : (e) =>
                        handleNewInputChange(e, newEducation, setNewEducation)
                }
                required={'required'}
              ></InputGroup>
              <InputGroup
                ...
                name="degree"
                value={
                  mode === 'edit' ? list[formIndex].degree : newEducation.degree
                }
                onChange={
                  mode === 'edit'
                    ? handleInputChange
              ...
              <div className="form-button-container">
                ...
                <button
                  type="submit"
                  onClick={
                    mode === 'edit' ? () => handleCloseForm('education') : null
                  }
                  className="form-save"
                >
