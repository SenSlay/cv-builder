...
export default function EducationEdit({ list, showForm, mode, formIndex, handleShowForm, handleCloseForm, handleCancelForm, handleInputChange, handleNewInputChange, handleAddItem, handleDeleteItem }) {
    ...
    return (
        <div className='education-input edit-section '>
            ...
            {showForm && (
                <form name='education' className='education-form' onSubmit={mode === 'edit' ? null : (e) => handleAddItem(e, newEducation, setNewEducation, initialNewEducation)}>
