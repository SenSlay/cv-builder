...
export default function SkillsEdit({ list, showForm, mode, formIndex, handleShowForm, handleCloseForm, handleCancelForm, handleInputChange, handleNewInputChange, handleAddItem, handleDeleteItem }) {
  ...
  return (
    <div className="skills-input edit-section">
        ...
        {!showForm && (
            ...
            {showForm && (
                <form name='skill' onSubmit={mode === 'edit' ? null : (e) => handleAddItem(e, newSkill, setNewSkill, initialNewSkill)} className='Skill-form'>
