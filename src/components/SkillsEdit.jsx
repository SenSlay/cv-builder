          ...
          {showForm && (
            <form
              ...
              onSubmit={
                mode === 'edit'
                  ? null
                  : (e) =>
                      handleAddItem(e, newSkill, setNewSkill, initialNewSkill)
              }
            ...
            >
              <InputGroup
                ...
                name="category"
                value={
                  mode === 'edit' ? list[formIndex].category : newSkill.category
                }
                onChange={
                  mode === 'edit'
                    ? handleInputChange
                    : (e) => handleNewInputChange(e, newSkill, setNewSkill)
                }
              ></InputGroup>
              <InputGroup
                label="Skills"
              ...
              <div className="form-button-container">
                ...
                <button
                  type="submit"
                  onClick={
                    mode === 'edit' ? () => handleCloseForm('skill') : null
                  }
                  className="form-save"
                >
