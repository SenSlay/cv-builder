        ...
        <div className='experience-input edit-section'>
            ...
            {isExpanded && (
              <>
                ...
                {showForm && (
                    <form name='experience' onSubmit={mode === 'edit' ? null : (e) => handleAddItem(e, newExperience, setNewExperience, initialNewExperience)} className='experience-form section-form'>
