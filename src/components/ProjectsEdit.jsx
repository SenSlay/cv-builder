            ...
            >
              <InputGroup
                ...
                onChange={
                  mode === 'edit'
                    ? handleInputChange
                    : (e) => handleNewInputChange(e, newProject, setNewProject)
                }
              ></InputGroup>
              <InputGroup
                label="Tools"
                ...
                name="tools"
                value={
                  mode === 'edit' ? list[formIndex].tools : newProject.tools
                }
                onChange={
                  mode === 'edit'
                    ? handleInputChange
                ...
                <InputGroup
                  ...
                  onChange={
                    mode === 'edit'
                      ? handleInputChange
                      : (e) =>
                          handleNewInputChange(e, newProject, setNewProject)
                  }
                ></InputGroup>
                <InputGroup
                  label="end-date"
              ...
              <div className="form-button-container">
                ...
                <button
                  type="submit"
                  onClick={
                    mode === 'edit' ? () => handleCloseForm('project') : null
                  }
                  className="form-save"
                >
